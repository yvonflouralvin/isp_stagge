...
export default async function IspStageDashboardWidget(props: PageProps) {
    ...
    if (props.user?.permissions?.find(perm => (
        ...
        try {
            ...
            dashboardWidget.push(<div key={1} className="flex w-full gap-[10px] flex-wrap mt-[20px]">
                ...
                <div key={2} className="p-[20px] rounded shadow-md bg-white flex flex-col">
                ...
                <div key={3} className="p-[20px] rounded shadow-md bg-white flex flex-col">
                ...
                <div key={4} className="p-[20px] rounded shadow-md bg-white flex flex-col">
