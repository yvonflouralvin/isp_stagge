            ...
            <div className="border border-black mt-[10px] divide-y-[1px] divide-black">
                {
                    students.map((student) => {
                        return <p key={student.id} className="text-[13px] text-gray-500 px-[20px] py-[6px] my-[3px] cursor-pointer hover:bg-[0,0,0,0.02] w-full">{student.user.name} {student.user.last_name} {student.user.first_name}</p>
                    })
                }
