    ...
    return <>
        ...
        <Modal isOpen={isOpen} onClose={() => setIsOpen(false)}>
            <ModalContent>
                ...
                <ModalBody>
                    <div>
                        <p className='text-gray-500'>Vous pouvez consulter et configurer les options des projets tutorés</p>
                        <div className='mt-[10px]'>
                            <p className='font-light text-gray-500 text-[13px]'>Nombre d'étudiants par Groupe</p>
                            {isUpdating === false && <p className='font-bold'>{department_settings ? `${department_settings.max_tutore_project_member_group}` : ""}</p>}
